...
<template>
  <Teleport to="body">
    <div class="fixed inset-0 z-50 flex backdrop-blur-2xl bg-neutral-100/40">
      ...
      <div
        class="flex-1 m-6 bg-background rounded-2xl border border-border flex flex-col overflow-y-auto"
      >
        <!-- Panel header -->
        ...
        <!-- Post content -->
        <div v-if="post" class="p-4 flex flex-col gap-5">
          <!-- Author -->
          <div
          ...
          >
            ...
            <div>
              ...
              <p class="text-xs text-muted-foreground">@{{ post.profile.username }}</p>
            </div>
          </div>

          <!-- Description -->
          <p v-if="post.description" class="text-sm text-muted-foreground leading-relaxed italic">
            "{{ post.description }}"
          </p>
        ...
        <div v-else-if="isPending" class="p-4 flex flex-col gap-4">
